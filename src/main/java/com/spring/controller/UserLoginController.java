...
public class UserLoginController extends BaseController {
     ...
     * @return
     */
    protected String authLoginUser(boolean isAdmin, String username, String password, String cx) {
        ...
        if (cx.equals("管理员")) {
            table = "admins";
            Admins user = adminsService.login(username, password);
            if (user == null) {
        ...
        if (cx.equals("用户")) {
            ...
            session.setAttribute("mailbox", user.getmailbox());
    ...
    public String authLogin() {
        ...
        return authLoginUser(false, username, password, cx);
    }
    ...
    public String authAdminLogin() {
        ...
        String password = Request.get("password");
        String cx = Request.get("cx");
        return authLoginUser(true, username, password, cx);
    }
    ...
    public String editPassword() {
        ...
        String newpassword2 = Request.get("newpassword2");
        ...
        if (cx.equals("管理员")) {
            ...
            adminsService.updatePassword(user.getId(), newpassword);
        }
        if (cx.equals("用户")) {
