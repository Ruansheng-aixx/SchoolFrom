...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">添加论坛帖子:</div>
            <div class="panel-body">
                <form action="forumpostsinsert.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_categorization3"
                                    data-value=""
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <textarea id="postcontent" name="postcontent" style="max-width: 750px; width: 100%; height: 300px"></textarea>
                                <script>
                                    (function () {
