    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="announcementinsert.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <textarea id="announcementcontent" name="announcementcontent" style="max-width: 750px; width: 100%; height: 300px"></textarea>
                                <script>
                                    (function () {
