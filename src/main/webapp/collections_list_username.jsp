...
<div style="padding: 10px" class="admin-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form action="collections_batch.do" method="post" id="form-batch">
                        ...
                        ><c:set var="i" value="${i+1}"/><c:set var="map" value="${map}" scope="request"/>
                            <tr id="${map.id}" pid="">
                                ...
                                <td align="center">
                                    ...
                                    <a href="collections_delete.do?id=${map.id}" onclick="return confirm('确定要删除？')">删除</a>
                                    <!--qiatnalijne-->
                                </td>
                            </tr>
                        </c:forEach>
                ...
                <div class="" style="margin-top: 10px">
                    <label><input type="checkbox" value="1"
                                  onclick="$('.list-table input.ids').prop('checked' , this.checked)"/> 全选/全不选</label>
