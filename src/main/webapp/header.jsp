        ...
        <div class="container">
            ...
            <div class="row" gutter="20">
                <div class="col-xs-12 col-sm-12 col-md-7 logo-holder">
                    <!-- ============================================================= LOGO ============================================================= -->
                    <div class="logo"><a href="./"> 校园论坛 </a></div>
                    <!-- /.logo -->
                    <!-- ============================================================= LOGO : END ============================================================= -->
                </div>
                <!-- /.logo-holder -->
        ...
        <div class="container">
            ...
            <div class="nav-list clearfix">
                <ul class="clearfix" id="navbar-str">
                    ...
                    <li>
                        <a href="forumpostslist.do">论坛 </a>
                        <ul class="nav-child">
                            <ssm:sql var="mappostcategorization1" type="select"> SELECT id,categorizationname FROM postcategorization </ssm:sql>
                            <c:forEach items="${mappostcategorization1}" var="m"
                                ><c:set var="m" value="${m}" scope="request" />
                                <li><a href="forumpostslist.do?categorization=${m.id}">${m.categorizationname}</a></li>
                            </c:forEach>
                        </ul>
                    </li>
                    <li>
                        <a href="announcementlist.do">公告 </a>
                    </li>
                    <li>
                        <a href="messageboardsadd.do">留言 </a>
                    </li>
                    <li>
                        <a href="useradd.do">注册 </a>
                    </li>
                    <li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="pa10">
                        <form action="authLogin.do?ac=login&a=a" method="post">
                            <!-- form 标签开始 -->
