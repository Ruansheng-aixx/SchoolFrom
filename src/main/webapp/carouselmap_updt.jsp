...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑轮播图:</div>
            <div class="panel-body">
                <form action="carouselmapupdate.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                            ...
                            <div class="col-sm-10">
                                <div class="input-group" style="width: 250px">
                                    <input
                                        ...
                                        class="form-control"
                                        data-rule-required="true"
                                        data-msg-required="请填写图片"
                                        id="image"
                                        name="image"
                                        value="${Info.html(mmm.image)}"
                                    />
