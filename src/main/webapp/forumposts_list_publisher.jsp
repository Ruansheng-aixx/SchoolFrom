            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_categorization2" data-value="${param.categorization}"
                        ...
                        <script>
                            $(".class_categorization2").val($(".class_categorization2").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        帖子名称
